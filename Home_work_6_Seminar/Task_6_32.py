...
# ищем индексы, соответствующие числам в заданном диапазоне
def check_indexes(array, min_num, max_num):
    return [i for i in range(len(array)) if array[i] >= min_num and array[i] <= max_num]
# выводим результат
print(f'check_indexes(array, {min_num}, {max_num}) {check_indexes(array, min_num, max_num)}')